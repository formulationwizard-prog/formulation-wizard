...
export const INGREDIENT_SPECS: Record<string, IngredientSpec> = {
  ...
  'Whole Allspice (Jamaican)':                 { brix: 0, moisture: 8,  aw: 0.35, pH: 5.4, source: 'ai-estimate', confidence: 'unverified', notes: 'Round 7 (2026-05-08): catalog mate added; chemistry row originated as stranded-chemistry-resolution placeholder in Round 6.' },
  ...
  // equilibrium pH); industry COA ranges for white-wine + sherry vinegars;
  // Jungbunzlauer / Niacet TDS for sodium citrate + calcium lactate;
  // Michael Foods spec for 10%-salted liquid egg yolk; Kerry Red Arrow TDS
  // for liquid smoke. Whole Allspice (Jamaican) chemistry already exists at
  // line 373 — Round 7 only updated its note (no new spec needed).
